...
urlpatterns = [
    ...
    url(r'^profile/(?P<pk>[0-9A-Za-z]+)/$', grumblr.views.profile, name='profile'),
    ...
    url(r'^photo/(?P<pk>[0-9A-Za-z]+)/$', grumblr.views.upload_photo, name='photo'),
    url(r'^follow/(?P<pk>[0-9A-Za-z]+)/$', grumblr.views.follow_stream, name='follow_stream'),
    ...
    # url(r'^get-posts/(?P<time>.+)$', grumblr.views.get_posts),
    ...
    url(r'^add-comment/(?P<pk>[0-9]+)$', grumblr.views.add_comment, name="add-comment"),
]
